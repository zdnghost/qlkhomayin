...
public class manegerpanel extends JPanel {
    ...
    public manegerpanel() throws SQLException {
        ...
        controller.manegercontrol.newtable();
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                controller.manegercontrol.chonhang();
        }});
        ...
        add.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
             mayin a=controller.manegercontrol.setobject();
             controller.manegercontrol.adddata(a);
            }
        });
        ...
        delete.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                mayin a=controller.manegercontrol.setobject();
                controller.manegercontrol.deletedata(a);
            }
        });
        ...
        update.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(key=="")
                    key=a.masp;
                controller.manegercontrol.updatedata(a);
            }
        });
